# PiPhi Network Philips Hue Direct

Philips Hue Zigbee device-profile integration that consumes an existing PiPhi coordinator without claiming radio ownership.
